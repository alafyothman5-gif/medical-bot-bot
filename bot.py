...
async def panel_callback(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if action == "progress":
        ...
        msg = (
            ...
            f"تنتهي في: {exp_txt}\n"
            f"User ID الخاص بك:\n`{uid}`\n\n"
            "اختر الاشتراك الذي تريده:\n\n"
            "💎 Premium شهري — 20 د.ل\n"
            "• 3 ملخصات يومياً\n"
            "• 3 Basic يومياً\n"
            "• 2 Cases + 2 Challenge يومياً\n"
            "• OSCE مرتين بالأسبوع\n\n"
            "🔥 Premium فصل كامل / 4 شهور — 45 د.ل / 4 شهور\n"
            "• نفس مزايا Premium بسعر أوفر\n\n"
            "🚀 Premium Plus فصل كامل / 4 شهور — 65 د.ل / 4 شهور\n"
            "• 5 ملخصات يومياً\n"
            "• 5 Basic يومياً\n"
            "• 3 Cases + 3 Challenge يومياً\n"
            "• OSCE يومياً\n\n"
            f"رقم المدار للتحويل:\n`{madar}`\n\n"
            "اضغط الخطة التي تريدها ليظهر لك طلب جاهز فيه رقمك ورقم التحويل."
        )
        await safe_edit(query, msg, parse_mode="Markdown", reply_markup=InlineKeyboardMarkup([
            ...
            [InlineKeyboardButton("🚀 Premium Plus فصل كامل / 4 شهور — 65 د.ل", callback_data="payment:premium_plus_semester")],
