...
async def admin_extract_lecture_text(raw_bytes: bytes, file_name: str, mime_type: str, file_type: str) -> Tuple[str, str]:
    """Return (text, method). Normal extraction first; admin-only Gemini smart extraction fallback."""
    text = ""
    method = "local"
    ...
    # Admin-only smart support: old PPT, scanned PDF, slide images, image-only files.
